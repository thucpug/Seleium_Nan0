...
namespace Selenium_Nano._2Captcha
{
    class HCaptcha2Captcha
    {
        ...
        {
            HCaptcha2Captcha.captcha_service_key = service_key;
        }
        ...
        public string SendRequest() // HTTP POST
        {
            try
            {
                ...
                var postData = "key=" + HCaptcha2Captcha.captcha_service_key + "&method=userrecaptcha&googlekey=" + this.site_key + "&page_url=" + this.page_url;
        ...
        public string getToken(string captcha_id)  // HTTP GET
        {
            ...
            webClient.QueryString.Add("key", HCaptcha2Captcha.captcha_service_key);
